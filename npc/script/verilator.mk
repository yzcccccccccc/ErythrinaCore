...
Verilator_SFLG	+= -cc --exe --trace-fst -O3 --build -j -CFLAGS "${Verilator_CFLG}" -LDFLAGS "${Verilator_LDFLG}" --autoflush -vpi
Verilator_VFLG	+= -cc --trace-fst -O3 --build -vpi# Only pack up the .v files
