...
sta: $(V_FILE_TIME)
	@echo $(RTL_FILE)
	@$(MAKE) -C $(YOSYSTA_PATH) sta RES_PATH=$(RES_PATH) DESIGN=TimingTop SDC_FILE=$(SDC_FILE) RTL_FILES="$(RTL_FILE)" CLK_FREQ_MHZ=100 RESULT_BASE_DIR=$(RESULT_BASE)